...
\begin{figure*}
\begin{center}
\includegraphics[width=0.85\linewidth]{figures/noisy_labels/diagram.pdf}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.9\linewidth]{figures/noisy_labels/cm_strong_weak_labels.pdf}
\end{center}
...
\begin{figure*}
\begin{center}
\includegraphics[width=0.95\linewidth]{figures/noisy_labels/model_output.pdf}

...
\begin{figure*}[t]
\begin{center}
\includegraphics[width=0.9\linewidth]{figures/person_search/framework.pdf}
\end{center}
...
\begin{figure*}[t]
\begin{center}
\includegraphics[width=0.9\linewidth]{figures/person_search/oim.pdf}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.75\linewidth]{figures/person_search/height-distr.pdf}
\end{center}
\vspace{-3ex}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.75\linewidth]{figures/person_search/detector-pr-curves.pdf}
\end{center}
\vspace{-4ex}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.8\linewidth]{figures/person_search/oim-vs-softmax.pdf}
\end{center}
\vspace{-3ex}

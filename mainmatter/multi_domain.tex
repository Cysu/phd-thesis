...
\section{Joint Single Task Learning} % (fold)
\label{sec:md-method}
...
% subsection md-prob-formulation (end)

\subsection{Objectives Functions} % (fold)
...
% subsection md-jstl-objectives (end)
...
\end{table*}
% section md-network-arch (end)

\section{Domain Guided Dropout} % (fold)

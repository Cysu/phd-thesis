...
% Moreover, since the two photos could be captured from different camera views and the two people could have various poses, their arrays of integers often significantly misaligned. It thus raises another challenge of how to correctly compare the semantic meanings between two images.
